...
<html lang="zh-ch">
    ...
    <head>
        ...
        <link rel="shortcut icon" href="https://static.eallion.com/favicon.ico" />
    </head>
        ...
        <div class="index-main">
            <div class="header-main">
                ...
                <div class="weather-main">
                    <iframe width="400" height="263" frameborder="0" scrolling="no" hspace="0" allowtransparency="true" src="https://i.tianqi.com/?c=code&a=getcode&id=27&icon=1"></iframe>
                </div>
        ...
        fetch(jsonUrl)
            ...
            .then((resdata) => {
                ...
                for (var i = 0; i < data.length; i++) {
                    ...
                    result += `<li class="item"><i class="fa fa-twitter"></i>：<a href="https://eallion.com/memos/" target="_blank">${newtickerContent}</a></li>`;
                }
